...
def dixon_coles_adjustment(home_goals, away_goals, rho, mu_x, mu_y):
    if home_goals == 0 and away_goals == 0: return 1 - rho * mu_x * mu_y
    elif home_goals == 0 and away_goals == 1: return 1 + rho * mu_x
    elif home_goals == 1 and away_goals == 0: return 1 + rho * mu_y
